		...
		$.post(
			...
			function (data) {
				...
				if (!data.error) {
					...
					// 	localStorage.getItem("result5/JTS") +
					// 	` odgadniętych 5-lit. słów </div>
                    // <div class="result-letter">` +
					// 	localStorage.getItem("result6/JTS") +
					// 	` odgadniętych 6-lit. słów </div>
                    // <div class="result-letter">` +
					// 	localStorage.getItem("result7/JTS") +
					// 	` odgadniętych 7-lit. słów </div>
                    // <div class="result-letter">` +
					// 	localStorage.getItem("result8/JTS") +
					// 	` odgadniętych 8-lit. słów </div>
                    // <div class="result-letter">` +
					// 	localStorage.getItem("result9/JTS") +
					// 	` odgadniętych 9-lit. słów </div>
					...
					// $.getScript("app/logout.js").done(function () {
